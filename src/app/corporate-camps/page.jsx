...
import { corporateEvents } from "../../utils/user/user.util";
...
const CorporateEvents = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const result = await corporateEvents(dataToSend);
  ...
  return (
    <div className="w-full bg-[#f4e7dd] min-h-screen pt-28 px-4 md:px-8 lg:px-12" style={style}>
      <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-center justify-between gap-12 pb-20">
        ...
        <div className="w-full md:w-1/2 space-y-6 md:pr-8">
          <div className="space-y-4">
            <h1 className="text-[24px] md:text-[28px] font-bold text-[var(--listText)] leading-tight">
              Corporate Reproductive Health Drives with Aarsh ReproHealth
            </h1>
            <p className="text-[#4a4a4a] text-base md:text-lg">
              Help us bring Reproductive Health & Wellness Drives with Aarsh ReproHealth to your employees.
              Share your details in the form to schedule a call to discuss.
            </p>
          </div>
          <div className="w-full  max-w-sm md:max-w-[600px] border rounded-lg">
            <Image
              src={partner.partnerBanner}
        ...
        <div className="w-full md:w-1/2">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-800">
                  Share a brief about your company
                </label>
                <textarea
                  name="message"
