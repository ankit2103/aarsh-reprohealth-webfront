...
const DiagnosticSubscriptionSEO = ({ staticData, nonStaticData, terms }) => {
  const allPlans = [...staticData, ...nonStaticData];

  return (
    <Head>
      <title>Diagnostic Centre Subscription Plans | Aarsh ReproHealth</title>
      <meta
        name="description"
        content="Explore Aarsh ReproHealth's exclusive subscription plans for diagnostic centres. Enhance visibility, grow revenue, and access wellness drive opportunities."
      />
      <meta name="robots" content="index, follow" />
      <link
        rel="canonical"
        href="https://www.aarshreprohealth.com/diagnostic-subscription"
      />

      {/* Schema.org - List of Diagnostic Centre Subscription Plans */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ItemList",
            name: "Diagnostic Centre Subscription Plans - Aarsh ReproHealth",
      ...
      {/* Schema.org - FAQs for Subscription Terms */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
...
const staticData = [
  {
    ...
    plan: {
      ...
      features: [
        ...
        {
          list: "Advertising opportunity - 1 Videos or Banner of the Diagnostic Centre, per month to feature on the Platform.",
        },
        {
          list: "Complimentary Portfolio Page showcasing the Diagnostic Centre’s profile and services hosted by Aarsh ReproHealth.",
        },
        { list: "80% Revenue Share with the Diagnostic Centre on Tests & Procedure**" },
      ],
  ...
  },
  {
    ...
    plan: {
      ...
      features: [
        ...
        {
          list: "Advertising opportunity - 2 Videos or Banner of the Diagnostic Centre, per month to feature on the Platform.",
        },
        {
          list: "Complimentary Portfolio Page showcasing the Diagnostic Centre’ss profile and services hosted by Aarsh ReproHealth.",
        },
        { list: "80% Revenue Share with the Diagnostic Centre on Tests & Procedure**" },
      ],
      extraDiscount: "A further 5% can be given with a Promo Code",
...
const nonStaticData = [
  {
    ...
    plan: {
      tenure: "Till upgradation to Paid Packages", // Updated from "Try for Free"
      originalPrice: 0,
      discountPrecent: 0,
      discountedPrice: 0,
      features: [
        {
          list: "Social Media Visibility – INR 5000.00 per Social post on Instagram, Facebook & LinkedIn",
        },
        {
          list: "Portfolio Page showcasing the Diagnostic Centre’s profile and services hosted by Aarsh ReproHealth for INR 5000.00 ",
        },
        {
          list: "65% Revenue Share with the Diagnostic Centre on Tests & Procedures**",
        },
      ],
    },
    _id: 3,
        ...
        <div className="w-full flex flex-col  items-center justify-center">
          <div className="w-full text-center lg:w-[50%] ">
            <h1 className="text-xl md:text-2xl lg:text-3xl capitalize">
              Select the Best Plan For Your Labs
            </h1>
            <p className="text-sm text-[var(--greyP)] mt-2 mb-5">
              "Pick the subscription plan designed specifically for diagnostic
              centers—boost visibility, gain referrals, and collaborate on health
              screenings and diagnostics. From social promotions to
              revenue-sharing opportunities, streamline your services and expand
              your reach with ease."
            </p>
          </div>
        </div>
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-6 mb-14">
              {staticData.slice(0, 3).map((item) => (
                <div
                  key={item._id}
                  className={`relative transition-transform duration-300 ease-in-out transform hover:scale-[1.05] rounded-[32px] p-6 min-h-[620px]   md:min-h-[620px] lg:min-h-[520px] ${item?.plan?.tenure === "Try for Free"
                ...
                >
                  ...
                  <div className="flex gap-2 justify-center mt-4">
                    <span
                      className={`text-md font-normal px-4 py-1 rounded-full ${item?.plan?.tenure === "Try for Free"
                        ? "text-[#fff] border-[1px] bg-blue-500 "
                        : item?.plan?.tenure === "12 Months"
