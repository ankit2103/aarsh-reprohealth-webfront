...
const SubscriptionSEO = ({ staticData, nonStaticData, terms }) => {
  const allPlans = [...staticData, ...nonStaticData];

  return (
    <Head>
      <title>Doctor Subscription Plans | Aarsh ReproHealth</title>
      <meta
        name="description"
        content="Explore Aarsh ReproHealth's subscription plans for doctors. Get featured on social media, portfolio pages, webinars, and enjoy high revenue share benefits."
      />
      <meta name="robots" content="index, follow" />
      <link
        rel="canonical"
        href="https://www.aarshreprohealth.com/doctor-subscription"
      />

      {/* Schema for all plans */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ItemList",
            name: "Doctor Subscription Plans - Aarsh ReproHealth",
...
const staticData = [
  {
    ...
    plan: {
      ...
      features: [
        ...
        {
          list: "Advertising opportunity - 1 Video or Banner of the Doctor or his specialty per month to feature on the Platform.",
        },
        {
          list: "Complimentary Portfolio Page showcasing the Doctor’s profile and services hosted by Aarsh ReproHealth.",
        },
        {
          list: "80% Revenue Share with the Doctor on Online & In-person Consultations**",
        },
      ],
  ...
  },
  {
    ...
    plan: {
      ...
      features: [
        ...
        {
          list: "Invites to 2 Seminars/Corporate Reproductive Wellness Drives/Webinars*",
        },
        {
          list: "Advertising opportunity - 1 Video or Banner of the Doctor or his specialty per month to feature on the Platform.",
        },
  ...
  },
  {
    ...
    plan: {
      ...
      features: [
        ...
        {
          list: "Invites to 3 Seminars/Corporate Reproductive Wellness Drives/Webinars*",
        },
        {
          list: "Advertising opportunity - 1 Video or Banner of the Doctor or his specialty per month to feature on the Platform.",
        },
...
const nonStaticData = [
  {
    ...
    plan: {
      tenure: "Till upgradation to Paid Packages",
      originalPrice: 0,
      discountPrecent: 0,
      discountedPrice: 0,
      features: [
        {
          list: "Social Media Visibility – INR 2500.00 per Social post on Instagram, Facebook & LinkedIn  ",
        },
        {
          list: "Portfolio Page showcasing the Doctor’s profile and services hosted by Aarsh ReproHealth for INR 3000.00",
        },
        {
          list: "65% Revenue Share with the Doctor on Online & In-person Consultations**",
        },
      ],
    },
    _id: 3,
...
const terms = [
  ...
  {
    _id: 1,
    title: "Revenue Share for Corporate Reproductive Health Drives & Webinars",
  ...
  {
    _id: 2,
    title: "Revenue Share for Seminars ",
    des: "For Seminars and Conferences, 20% of the Seminar/Conference fees paid by invitees to Aarsh ReproHealth, will be shared with Subscribed Members unless discussed and concluded and accepted by both parties in writing.",
  },
  {
    _id: 3,
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mt-6 mb-14">
      {[...Array(count)].map((_, index) => (
        <div
          key={index}
          className="relative animate-pulse rounded-[32px] p-6 min-h-[550px] border border-gray-200 shadow-md bg-white"
        >
          {/* Plan name */}
...
const DoctorPackage = () => {
  ...
  const getStyleByTenure = (tenure) => {
    switch (tenure) {
      case "Try for Free":
        return "text-[#fff] border-[1px] bg-blue-500";
      case "12 Months":
        return "text-[#c59c26] border border-[#c59c26] bg-[rgba(197,156,38,0.1)]";
      case "6 Months":
        return "text-[#9f9f9f] border border-[#9f9f9f] bg-[rgba(188,188,188,0.1)]";
      default:
        return "text-[#cd7f32] border border-[#cd7f32] bg-[rgba(205,127,50,0.1)]";
    }
  };
      ...
      <div className="w-full flex flex-col  items-center justify-center">
        <div className="w-full text-center lg:w-[50%] ">
          ...
          <p className="text-sm text-[var(--greyP)] mt-2 mb-5">
            "Select a subscription plan curated for medical
            professionals—enhance your digital presence, connect with patients,
            and grow your practice through featured listings, social outreach,
            and exclusive camp invites. Your expertise deserves the spotlight."
          </p>
        </div>
      </div>
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-6 mb-14">
            {staticData.slice(0, 3).map((item) => (
              <div
                key={item._id}
                className={`relative transition-transform duration-300 ease-in-out transform hover:scale-[1.05] rounded-[32px] p-6 min-h-[580px] ${item?.plan?.tenure === "Try for Free"
              ...
              >
                <h3
                  className={`text-3xl font-normal text-center ${item?.plan?.tenure === "Try for Free"
                    ? " text-blue-500"
                    : item.plan?.tenure === "12 Months"
                      ? "text-[#c59c26]"
                      : item?.plan?.tenure === "6 Months"
                ...
                <div className="flex items-center justify-center gap-2 mt-2">
                  ...
                  <h3
                    className={` font-normal  rounded-full ${item?.plan?.tenure === "Try for Free"
                ...
                <div className="flex gap-2 justify-center mt-4">
                  ...
                  <span
                    ...
                    className={`inline-block  text-md font-normal px-4 py-1 rounded-full ${item?.plan?.tenure === "Try for Free"
                      ? "text-[#fff] border-[1px] bg-blue-500 "
                      : item?.plan?.tenure === "12 Months"
                ...
                {/* <div className="flex justify-center mt-2">
                  ...
                  >
                    {item?.plan?.discountPrecent}% &nbsp;
                    <span>INR ₹</span>
                    <span className="line-through">{item?.plan?.originalPrice.toLocaleString("en-IN")}</span>
                  </span>
                </div> */}
                ...
                <div className="absolute bottom-4 left-0 w-full px-6 mt-5">
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 py-3 rounded-full font-medium text-white ${item?.plan?.tenure === "Try for Free"
                      ? " bg-blue-500"
                      : item?.plan?.tenure === "12 Months"
                        ? "bg-[#c59c26]"
                        : item?.plan?.tenure === "6 Months"
              ...
              .map((plans, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-0 w-full px-6 mt-5">
                    <button
                      onClick={handleNavigate}
                      className="w-full flex items-center justify-center gap-2 py-3 rounded-full font-medium text-white bg-blue-500"
                    >
